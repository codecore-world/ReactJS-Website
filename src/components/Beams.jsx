...
const Beams = ({
  ...
  // Support CSS variable for lightColor
  let color = lightColor;
  if (typeof color === 'string' && color.startsWith('var(')) {
    color = getComputedStyle(document.documentElement).getPropertyValue(color.replace('var(', '').replace(')', '')).trim() || '#ed96b8';
  }
    ...
    <CanvasWrapper>
      <group rotation={[0, 0, degToRad(rotation)]}>
        <PlaneNoise
          ...
          height={beamHeight}
        />
        <DirLight color={color} position={[0, 3, 10]} />
      </group>
